...
def filter_by_currency(all_transactions: Any, currency: Any) -> Generator:
...
def transaction_descriptions(list_transactions: Any) -> Any:
...
def card_number_generator(initial_value: int, final_value: int) -> Generator:
